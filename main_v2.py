...
class MnistClassification():
    ...
    def _build_graph_and_get_loss(self):
        ...
        if "random"  in self.net_struct:
            ...
            #self.print_ops.append(tf.print("KL loss:", utils.KL_divergence_between_normal(self.mu_1, utils.deviation_rho(self.rho_1),
                                                            #tf.fill(tf.shape(self.mu_1), 0.0), tf.fill(tf.shape(self.rho_1), 1.0))))
        ...
        #self.print_ops.append(tf.print("average of mu_1: ",tf.reduce_mean(self.mu_1)) )
